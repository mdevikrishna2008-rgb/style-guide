...
# Function to extract the single main recommendation from the detailed options
def get_single_suggestion(options_list):
    # This extracts the main recommendation, discarding the optional "Try:" and "Avoid:" details
    if not options_list:
        return "N/A"
    suggestion = options_list[0]
    # Split at the first instance of Try: or Avoid: to keep only the main advice
